...
cmds = [
    'echo === host pipeline src tree ===',
    'find /home/zjlab/gravitationalwave-v4.31/gw-pipeline/src -maxdepth 4 -type f 2>&1 | sort',
    'echo === host pipeline src/pipeline subdirs ===',
    'ls -la /home/zjlab/gravitationalwave-v4.31/gw-pipeline/src/pipeline/ 2>&1',
    'echo === local src/pipeline subdirs ===',
]
for c in cmds:
    print('--- ' + c + ' ---')
